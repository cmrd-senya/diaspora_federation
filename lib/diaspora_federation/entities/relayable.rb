    ...
    module Relayable
      ...
      def to_xml
        entity_xml.tap do |xml|
          hash = to_h
          Relayable.update_signatures!(hash, self.class.parent_entity_class)
      ...
      def self.verify_signatures(data, entity_type="Post")
      ...
      # @param [Hash] data hash with data to verify
      def self.verify_parent_signature(data, entity_type="Post")
      ...
      def self.update_signatures!(data, entity_type="Post")
